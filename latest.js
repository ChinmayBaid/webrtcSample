! function (t) {
    if ("function" == typeof bootstrap) bootstrap("simplewebrtc", t);
    else if ("object" == typeof exports) module.exports = t();
    else if ("function" == typeof define && define.amd) define(t);
    else if ("undefined" != typeof ses) {
        if (!ses.ok()) return;
        ses.makeSimpleWebRTC = t
    } else "undefined" != typeof window ? window.SimpleWebRTC = t() : global.SimpleWebRTC = t()
}(function () {
    return function (t, e, n) {
        ...
        1: [
            function (t, e) {
                function n(t) {
                    ...
                    var s, a;
                    for (s in n) this.config[s] = n[s];
                    this.capabilities = r, i.call(this), a = this.connection = io.connect(this.config.url), a.on("connect", function () {
                        e.emit("ready", a.socket.sessionid), e.sessionReady = !0, e.testReadiness()
                    }), a.on("message", function (t) {
                        var n, o = e.webrtc.getPeers(t.from, t.roomType);
                        "offer" === t.type ? (n = e.webrtc.createPeer({
                            id: t.from,
                            type: t.roomType,
                            sharemyscreen: "screen" === t.roomType && !t.broadcaster
                        }), n.handleMessage(t)) : o.length && o.forEach(function (e) {
                            e.handleMessage(t)
                        })
                    }), a.on("remove", function (t) {
                        t.id !== e.connection.socket.sessionid && e.webrtc.removePeers(t.id, t.type)
                    }), this.webrtc = new o(t), ["mute", "unmute", "pause", "resume"].forEach(function (t) {
                        e[t] = e.webrtc[t].bind(e.webrtc)
                    }), this.webrtc.on("*", function (t) {
                        [].splice.call(arguments, 0, 0, t)
                    }), this.webrtc.on("localStream", function () {
                        e.testReadiness()
                    }), this.webrtc.on("message", function (t) {
                        e.connection.emit("message", t)
                ...
                n.prototype = Object.create(i.prototype, {
                ...
                }, n.prototype.handlePeerStreamAdded = function (t) {
                    var e = this.getRemoteVideoContainer(),
                        n = s(t.stream);
                    t.videoEl = n, n.id = this.getDomId(t), e && handleAddRemoteVideos(e,n), this.emit("videoAdded", n, t)
                }, n.prototype.handlePeerStreamRemoved = function (t) {
                    var e = this.getRemoteVideoContainer(),
                        n = t.videoEl;
                    this.config.autoRemoveVideos && e && n && handleRemoveRemoteVideos(e,n), n && this.emit("videoRemoved", n, t)
                }, n.prototype.getDomId = function (t) {
                    return [t.id, t.type, t.broadcaster ? "broadcasting" : "incoming"].join("_")
                }, n.prototype.setVolumeForAll = function (t) {
                    this.webrtc.peers.forEach(function (e) {
                        e.videoEl && (e.videoEl.volume = t)
                    })
                    ...
                    this.roomName = t, this.connection.emit("join", t, function (t, o) {
                        if (t) n.emit("error", t);
                            ...
                            for (i in o.clients) {
                                r = o.clients[i];
                                for (s in r) r[s] && (a = n.webrtc.createPeer({
                                    id: i,
                                    type: s
                                }), a.start())
                            }
                    ...
                    var t = this;
                    this.webrtc.startLocalMedia(null, function (e, n) {
                        console.log("starting local media", e, n), e ? t.emit(e) : s(n, t.getLocalVideoContainer(), {
                            muted: !0,
                            mirror: !0
                        })
                    })
                    ...
                    a(function (n, o) {
                        ...
                        n ? e.emit(n) : (e.webrtc.localScreen = o, i.id = "localScreen", s(o, i), r && r.appendChild(i), e.emit("localScreenAdded", i), e.connection.emit("shareScreen"), e.webrtc.peers.forEach(function (t) {
                            var n;
                            "video" === t.type && (n = e.webrtc.createPeer({
                                id: t.id,
                                type: "screen",
                                sharemyscreen: !0,
                                broadcaster: e.connection.socket.sessionid
                            }), n.start())
                        })), t && t(n, o)
                    })
                    ...
                    this.config.autoRemoveVideos && e && t && e.removeChild(t), t && this.emit("videoRemoved", t), n && n.stop(), this.webrtc.peers.forEach(function (t) {
                        t.broadcaster && t.end()
        ...
        4: [
            function (t, e) {
                var n = window.mozRTCPeerConnection || window.webkitRTCPeerConnection || window.RTCPeerConnection,
                    ...
                    a = window.webkitAudioContext || window.AudioContext;
                e.exports = {
                    support: !! n,
                    dataChannel: !! (n && n.prototype && n.prototype.createDataChannel),
                    prefix: r,
                    webAudio: !! a.prototype.createMediaStreamSource,
                    screenSharing: s,
                    AudioContext: a,
                    PeerConnection: n,
        ...
        5: [
            function (t, e) {
                e.exports = function (t, e, n) {
                    ...
                    if (n)
                        for (o in n) r[o] = n[o];
                    if (r.autoplay && (s.autoplay = "autoplay"), r.muted && (s.muted = !0), r.mirror && ["", "moz", "webkit", "o", "ms"].forEach(function (t) {
                        var e = t ? t + "Transform" : "transform";
                        s.style[e] = "scaleX(-1)"
                    }), i && i.createObjectURL) s.src = i.createObjectURL(t);
                    else if (s.srcObject) s.srcObject = t;
                    else {
        ...
        6: [
            function (t, e) {
                ...
                e.exports = function (t) {
                    ...
                    return "http:" === window.location.protocol ? (e = new Error("NavigatorUserMediaError"), e.name = "HTTPS_REQUIRED", t(e)) : (n(o, t), void 0)
                }
            }, {
                getusermedia: 7
            }
        ...
        8: [
            function (t, e) {
                ...
                e.exports = function (t, e) {
                    ...
                    return i || (e = t, t = r), n ? (n.call(navigator, t, function (t) {
                        e(null, t)
                    }, function (t) {
                        var n;
                        "string" == typeof t ? (n = new Error("NavigatorUserMediaError"), n.name = t === s ? s : a) : (n = t, n.name || (t.name = n[s] ? s : a)), e(n)
                    }), void 0) : (o = new Error("NavigatorUserMediaError"), o.name = "NOT_SUPPORTED_ERROR", e(o))
                }
            }, {}
        ],
        7: [
        ...
        2: [
            function (t, e) {
                function n(t) {
                    ...
                    i = this.config.log ? console.log.bind(console) : function () {}, this.peers = [], c.call(this), this.config.log && this.on("*", function (t, e, n) {
                        i("event:", t, e, n)
                    })
                }
                ...
                n.prototype = Object.create(c.prototype, {
                ...
                }, n.prototype.startLocalMedia = function (t, e) {
                    var n = this,
                        o = t || {
                            video: !0,
                            audio: !0
					...
					//Asks for permission of local media devices
                    s(o, function (t, i) {
                        t || (o.audio && n.setupAudioMonitor(i), n.localStream = i, n.gainController = new u(i), n.setMicIfEnabled(.5), n.emit("localStream", i)), e && e(t, i)
                    })
                ...
                }, n.prototype.setMicIfEnabled = function (t) {
                    this.config.autoAdjustMic && this.gainController.setGain(t)
                    ...
                    this.setMicIfEnabled(t ? 1 : 0), this.localStream.getAudioTracks().forEach(function (e) {
                        e.enabled = !! t
                    })
                ...
                }, n.prototype.removePeers = function (t, e) {
                    ...
                    var e = this;
                    i("getting", t.type, t), t.prefix && (this.browserPrefix = t.prefix), "offer" === t.type ? this.pc.answer(t.payload, function (t, n) {
                        e.send("answer", n)
                    ...
                    i("sending", t, n), this.parent.emit("message", n)
                    ...
                    this.stream = t.stream, this.parent.emit("peerStreamAdded", this)
        ...
        9: [
            function (t, e) {
                function n(t) {
                    if (this.support = o.webAudio, this.gain = 1, this.support) {
                        var e = this.context = new o.AudioContext;
                        this.microphone = e.createMediaStreamSource(t), this.gainFilter = e.createGain(), this.destination = e.createMediaStreamDestination(), this.outputStream = this.destination.stream, this.microphone.connect(this.gainFilter), this.gainFilter.connect(this.destination), t.removeTrack(t.getAudioTracks()[0]), t.addTrack(this.outputStream.getAudioTracks()[0])
                    }
                    this.stream = t
                }
                var o = t("webrtcsupport");
                n.prototype.setGain = function (t) {
...
! function () {
    ...
    function (t, e) {
        ...
        n.decodePacket = function (t) {
            ...
            if ("ï¿½" == t.charAt(0)) {
                for (var e = [], o = 1, i = ""; o < t.length; o++) "ï¿½" == t.charAt(o) ? (e.push(n.decodePacket(t.substr(o + 1).substr(0, i))), o += Number(i) + 1, i = "") : i += t.charAt(o);
                return e
            }
